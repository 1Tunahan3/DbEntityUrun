...
namespace DbEntityUrun
{
    public partial class FrmIstatistik : Form
    {
        ...
        private void FrmIstatistik_Load(object sender, EventArgs e)
        {
            ...
            label19.Text = db.TBLSATISS.Sum(x => x.FIYAT).ToString();
            ...
            label21.Text = (from x in db.TBLMUSTERI select x.MUSTERISEHIR).Distinct().Count().ToString();
            label17.Text = db.MARKAGETIR().FirstOrDefault();
        }
    }
}
